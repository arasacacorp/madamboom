      ...
      <section className="relative py-10 md:py-16 overflow-hidden">
        ...
        >
          ...
          <div className="order-2">
            ...
            >
              <p>
                Бурлеск-кабаре «Мадам Бум» в Санкт-Петербурге — это современное шоу,
                объединяющее бурлеск, театр, танец, живой вокал и конферанс в атмосфере
                лучших европейских кабаре.
              </p>
              <p>
                По четвергам проходит классическая программа «Мадам Бум» — эффектные
                бурлеск-номера, живая музыка, театральная атмосфера и искромётный
                конферанс. Показы — на площадке Unity, в переулке Гривцова, 4.
              </p>
              <p>
                По субботам на сцене Ibiza (Садовая улица, 12) разворачивается «Джазовый
                бунт» — музыкально-театральное шоу, в котором живой джаз встречается с
                бурлеском и яркими сценическими номерами.
              </p>
              <p>
                Если вы ищете, куда сходить вечером в Санкт-Петербурге, хотите провести
                необычное свидание, отметить праздник или открыть для себя современное
                бурлеск-кабаре, «Мадам Бум» подарит вечер, который запомнится надолго.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                >
                  Классическая программа «Мадам Бум», площадка Unity, переулок Гривцова,
                  4.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                >
                  Джазовое шоу «Джазовый бунт», площадка Ibiza, Садовая улица, 12.
                </p>
              </div>
            </div>
          </div>
