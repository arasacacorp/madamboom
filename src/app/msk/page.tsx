...
/* ═══ Афиша в Москве (/msk) ═══
 * Editorial page: hero + afisha poster + descriptive text (provided by client)
 * + schedule/info cards + Moscow-only calendar (TicketsCloud widget
 *   madamboommsk.ticketscloud.org) + CTA + footer (sticky).
 */

const MSK_TICKETS_URL = 'https://madamboommsk.ticketscloud.org/'
    ...
    >
      ...
      <section className="relative pt-10 pb-6 md:pt-16 md:pb-8 overflow-hidden">
        ...
        <div className="relative flex flex-col items-center px-4 text-center">
          ...
          >
            Бурлеск-кабаре «Мадам Бум» в Москве
          </h1>
          ...
          >
            Бурлеск, театр, живой вокал и джаз — современное кабаре в сердце столицы.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div className="flex justify-center lg:justify-start order-1">
            ...
            >
              ...
              >
                <img
                  src="/images/afisha-msk.jpg"
                  alt="Афиша бурлеск-кабаре «Мадам Бум» в Москве — июль, ресторан «Гримёрка», Пушечная улица 9/6"
          ...
          <div className="order-2">
            ...
            >
              Бурлеск, театр и живой джаз на одной сцене
            </h2>
            <div
            ...
            >
              <p>
                Бурлеск-кабаре «Мадам Бум» — современное кабаре в Москве, объединяющее
                бурлеск, театр, танец, живой вокал, конферанс и атмосферу лучших
                европейских кабаре.
              </p>
              <p>
                Каждую пятницу мы встречаемся в ресторане «Гримёрка», где проходит
                классическая программа «Мадам Бум». Гостей ждут эффектные бурлеск-номера,
                живая музыка, театральная атмосфера, искромётный конферанс и вечер,
                наполненный красотой, юмором и элегантностью.
              </p>
              <p>
                По субботам проходит программа «Джазовый бум» — музыкально-театральное
                шоу, объединяющее живой джаз, бурлеск и яркие сценические номера. Показы
                проходят в отдельные субботы согласно афише проекта.
              </p>
              <p>
                Если вы ищете, куда сходить вечером в Москве, хотите провести необычное
                свидание, девичник, отметить праздник или открыть для себя современное
                бурлеск-кабаре с живым джазом, «Мадам Бум» подарит вечер, который
                запомнится надолго.
              </p>
            </div>
          </div>
      ...
      <section className="relative py-10 md:py-14 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-8" style={{ zIndex: 6 }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                >
                  Классическая программа «Мадам Бум», ресторан «Гримёрка», Пушечная
                  улица, 9/6.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                >
                  Джазовое шоу «Джазовый бум» согласно афише проекта.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            «Мадам Бум» — место, где бурлеск, театр и живой джаз превращают обычный
            вечер в настоящее событие.
          </p>
        </div>
      </section>

      {/* ═══ Moscow-only calendar ═══
       * cityFilter='М'  → /api/calendar?city=msk (only Moscow events)
       * widgetOverride  → all "Купить билеты" buttons open madamboommsk widget
       * title           → "Календарь событий в Москве" */}
      <Calendar
        cityFilter="М"
        widgetOverride={MSK_TICKETS_URL}
        title="Календарь событий в Москве"
      />
